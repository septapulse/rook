package io.septapulse.rook.test.tools;
...
public class ServiceConfigGenerator {
	...
	public static String generate(Class<?> serviceType, int tab) {
		...
		appendTab(sb, tab);
		sb.append("\"command\": \"java -cp lib/* io.septapulse.api.ServiceLauncher -st " + serviceType.getName() + " -sc ${config} -tt io.septapulse.rook.core.transport.websocket.WebsocketTransport -tc {}\",\n");
		appendTab(sb, tab);
		sb.append("\"arguments\": {\n");
